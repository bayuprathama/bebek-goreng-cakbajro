...
function Hero() {
  return (
    <div className="flex">
      ...
      <div className="flex-1 py-20 bg-yellow-300">
        <h1
          className={`${lobsterTwo.variable} font-lobsterTwo italic font-bold text-5xl text-center mx-6 text-red-700 xl:text-left xl:max-w-lg xl:text-7xl xl:mx-10`}
        >
